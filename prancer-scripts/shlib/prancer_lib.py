import sys
import json
from prancer_site import get_site
from prancer_result import get_result
from prancer_spider import get_spider
from prancer_output import get_output

def pr_hello_alert(url, title=None):
  # Message 1 Content:
  msg_data = {
      "uri": url + "/search?q=%3C%2Ffont%3E%3CscrIpt%3Ealert%281%29%3B%3C%2FscRipt%3E%3Cfont%3E",
      "method": "GET",
      "param": "q",
  ...
  if title is None:
      title = "Prancer Python Hello Alert"
